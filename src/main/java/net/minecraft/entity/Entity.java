...
import com.alan.clients.util.time.StopWatch;
...
public abstract class Entity implements ICommandSender {
    ...
    public com.alan.clients.util.time.StopWatch timer = new StopWatch();
    public com.alan.clients.util.time.StopWatch timerName = new StopWatch();
