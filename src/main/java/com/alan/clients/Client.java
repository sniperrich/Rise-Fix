...
import com.alan.clients.module.api.manager.TargetManager;
...
public enum Client {
    ...
    public static String NAME = "Asta";
    public static String VERSION = "1.0";
    public static String VERSION_FULL = "Beta1.0"; // Used to give more detailed build info on beta builds
    public static String VERSION_DATE = "October 28, 2023";
